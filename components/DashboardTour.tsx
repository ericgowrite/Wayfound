      ...
      steps: [
        {
          ...
          popover: {
            ...
            description:
              "This is you — how Wayfound knows what fits when you travel. Tap your name anytime to view or update your travel style.",
          },
        },
        {
          ...
          popover: {
            ...
            description:
              "Traveling with someone? Add them here. Wayfound finds what fits everyone — not just a compromise.",
          },
        },
        {
        ...
        },
        {
          ...
          popover: {
            ...
            description:
              "Pick your destination and let Wayfound find what fits. That's all there is to it.",
          },
        },
      ],
    });
